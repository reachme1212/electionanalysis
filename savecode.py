...
total_votes=0
# create an empty 'list candidate_options=[names]
candidate_options=[]
county_options=[]
# create a 'dictionary{}' to hold  key value pair that will be inside the list candidate_options{candidate name :votes they got}
#inside county_votes={countyname:total vote for the couty} 
candidate_votes={}
county_votes={}
